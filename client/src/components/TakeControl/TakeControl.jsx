    ...
    return (
        <section className="bg-blue-shade py-16">
            <div className="container flex flex-col items-center gap-6 text-center">
                ...
                <Link to="/login" className="bg-white-col hover:brightness-95 duration-300 text-pri-col py-3 lg:py-4 px-4 rounded-md sm:px-8 capitalize font-[600] lg:text-lg">
