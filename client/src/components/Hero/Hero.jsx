...
const Hero = () => {
    return (
        <section className="bg-pri-col min-h-[calc(100vh-4rem)] md:min-h-[calc(55vh-4rem)] lg:min-h-[calc(100vh-4rem)] flex items-center justify-center py-12">
            <div className="container h-full flex flex-col md:flex-row md:items-center gap-8">
                <div className="flex flex-col gap-6 md:w-[50%]">
                    <h2 
                      className="capitalize font-bold text-3xl min-[1200px]:text-5xl text-white-col"
                    >
                        track your finances effortlessly
                    </h2>

                    <p className="text-white-col min-[1200px]:text-lg/[2rem]">
                ...
                <div className="w-full h-full md:w-[50%]">
                    <img 
                      ...
                      className="w-full h-[60%] max-h-[20rem] object-cover rounded-md shadow-md"
                    />
                </div>
            </div>
        </section>
