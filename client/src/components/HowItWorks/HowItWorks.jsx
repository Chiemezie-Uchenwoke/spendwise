const HowItWorks = () => {
    ...
    return (
        <section id="how-it-works" className="top-margin bg-acc-col/70 py-16">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 sm:gap-4 lg:gap-8">
                    {
                        howItWorksSteps.map((step) => {
                            return (
                                <div key={step.id} className="flex flex-col gap-4 border border-black/15 py-8 px-4 rounded-md hover:bg-acc-col hover:border-blue-600/60 duration-300 ease-in-out">
