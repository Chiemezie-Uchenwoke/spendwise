                ...
                >
                    <div className="flex flex-col gap-8">   
                        <div className="flex flex-col gap-1">
                            ...
                            <p className="text-xs capitalize">Username</p>
                        </div>
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <h4 className="text-sm capitalize flex items-center gap-2 text-pri-col bg-pri-col/10 py-2 px-4 rounded-md text-center">
